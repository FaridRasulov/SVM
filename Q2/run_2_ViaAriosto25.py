...
import func_2_ViaAriosto25 as f
...
r = 10 # this is q parameter, we use r because the letter q is already used as a name of a cvxopt matrix
...
L_, b, NI, FE, mMdiff, obj, tr_time = f.fit_decom(X_train, y_train, kernel, C, gamma, r, maxit, tol,L_)
...
f.writetxt('output_question_2.txt', C, gamma, kernel, 'default', obj, conf_mat, test_acc, train_acc, NI, FE, mMdiff, r, tr_time)